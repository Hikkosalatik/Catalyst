...
CMDs[#CMDs + 1] = {NAME = 'remotespy / cspy', DESC = 'Opens Cobalt Spy'}
CMDs[#CMDs + 1] = {NAME = 'remotespy / hspy', DESC = 'Opens Hydroxide Spy'}
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/Hikkosalatik/decomp/refs/heads/main/IY.lua'))()")
	end
end)
...
addcmd("explorer", {"dex"}, function(args, speaker)
	notify("Loading", "Hold on a sec")
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Hikkosalatik/decomp/refs/heads/main/dex.lua"))()
end)
